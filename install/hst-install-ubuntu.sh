...
# ======================================================== #
#
# Control Panel Installer for Ubuntu
# https://www.p.com/
#
...
conflicts_pkg="exim4 mariadb-server apache2 nginx postfix ufw"
...
$bin/v-change-user-shell $username nologin no
...
tmpfile=$(mktemp -p /tmp)
dpkg --get-selections > $tmpfile
conflicts_pkg="exim4 mariadb-server apache2 nginx DevIT postfix ufw"
...
check_result $? "can't create admin user"
$DevIT/bin/v-change-user-shell $username nologin no
