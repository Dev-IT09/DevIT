		...
		<?php require $_SERVER["] . "/web/templates/includes/app-footer.php"; ?>
...
<?php } ?>
	...
	<?php require $_SERVER["] . "/web/templates/includes/jump-to-top-link.php"; ?>

	<?php if ($_SESSION["DEBUG_MODE"] == "true") {
		require $_SERVER["] . "/web/templates/pages/debug_panel.php";
	} ?>
