...
if (!empty($_GET["key"])) {
	...
	// Key data
	exec(CMD . "v-list-access-key " . $v_key . " json", $output, $return_var);
	...
	// APIs
	exec(CMD . "v-list-apis json", $output, $return_var);
	...
	exec(CMD . "v-list-access-keys $user json", $output, $return_var);
