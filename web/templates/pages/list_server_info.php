...
<head>
	...
	<?php require $_SERVER["] . "/web/templates/includes/title.php"; ?>
	<?php require $_SERVER["] . "/web/templates/includes/css.php"; ?>
	<?php require $_SERVER["] . "/web/templates/includes/js.php"; ?>
</head>
			...
			<div class="top-bar">
				<div class="container top-bar-inner">
					<div class="top-bar-left">
						<a href="/" class="top-bar-logo" title="<?= _("Control Panel") ?>">
							<img src="/images/logo-header.svg" alt="<?= _("Control Panel") ?>" width="54" height="29">
						</a>
					</div>
