...
if grep "geoip2" $data/templates/web/awstats/awstats.tpl; then
...
if [ -d /etc/awstats ]; then
	...
	echo "LoadPlugin=\"geoip2_country /usr/share/GeoIP/GeoLite2-Country.mmdb\"" >> $data/templates/web/awstats/awstats.tpl
