...
# Control Panel upgrade script for target version 1.3.0
...
# Set LOGIN_STYLE variable in conf
echo "[ * ] Updating configuration file: conf..."
$BIN/v-change-sys-config-value "LOGIN_STYLE" "default"

# Remove old lanugage files.
if [ -e $web/inc/i18n/en.php ]; then
